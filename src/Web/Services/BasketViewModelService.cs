...
namespace Web.Services
{
    public class BasketViewModelService : IBasketViewModelService
    {
        ...
        private string _createAnonyId = null!;
        private string CreateAnonymousId()
        {
            if (_createAnonyId != null) return _createAnonyId;

            _createAnonyId = Guid.NewGuid().ToString();

            HttpContext.Response.Cookies.Append(Constants.BASKET_COOKIE, _createAnonyId, new 
                CookieOptions() 
            { 
